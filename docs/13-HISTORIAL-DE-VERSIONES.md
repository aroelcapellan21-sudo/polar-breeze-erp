...
| `docs/anexos/02-ESTRUCTURA-OLIVER-FLUJOS-REALES.md` | Fuente de verdad — transcripción literal, pendiente de reconciliar contra `08-CATALOGO-DE-MODULOS.md` |
