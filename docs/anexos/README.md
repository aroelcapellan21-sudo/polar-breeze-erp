...
Almacenar documentación complementaria que no forma parte del cuerpo principal de la arquitectura (glosarios, referencias externas, investigaciones, notas de soporte, etc.).
